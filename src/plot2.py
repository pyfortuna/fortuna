...
# Plot chart
fig, ax = plt.subplots()
ax.plot_date(df.index.values, df['sma200'].values, color='b', linestyle='solid', linewidth=1, label='SMA/200')
ax.plot_date(df.index.values, df['sma20'].values, color='g', linestyle='solid', linewidth=1, label='SMA/20')
ax.plot_date(df.index.values, df['close'].values, color='r', linestyle='solid', linewidth=1, label=companyCode)
